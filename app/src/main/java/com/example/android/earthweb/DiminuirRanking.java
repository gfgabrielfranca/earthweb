...
public class DiminuirRanking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diminuir_ranking);
        ...
        progress = new ProgressDialog(DiminuirRanking.this);
        progress.setMessage("Diminuindo pontuação...");
        ...
        btnDiminuir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(networkInfo != null && networkInfo.isConnected()){
                    ...
                    if(CPF.isEmpty()){
                        Snackbar.make(findViewById(R.id.layoutDiminuir), "O campo de CPF não pode estar vazio", Snackbar.LENGTH_LONG).show();
                    }
                    else{
                        if(papel.isEmpty()){
                            papel = "0";
                        ...
                        parametros = "identificador=" + "batatavelha" + "&cpf=" + CPF + "&papel=" + papel + "&plastico=" + plastico + "&metal=" + metal + "&vidro=" + vidro + "&subtrair=" + "true";
                        new enviar().execute(url, parametros);
                    }
                }
                else{
                    Snackbar.make(findViewById(R.id.layoutDiminuir), "Nenhuma conexão foi encontrada", Snackbar.LENGTH_LONG).show();
                }
            }
        });
    }
    private class enviar extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String resultado){
            ...
            if (resultado.contains("ok")){
                ...
                Snackbar.make(findViewById(R.id.layoutDiminuir), "Erro na diminuição", Snackbar.LENGTH_LONG).show();
            }
